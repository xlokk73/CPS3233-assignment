...
_cls_inst._call(thisJoinPoint.getSignature().toString(), 88/*setMoving*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 88/*setMoving*/);
}
}
...
_cls_lift0 _cls_inst = _cls_lift0._get_cls_lift0_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 92/*openDoors*/);
...
_cls_lift0 _cls_inst = _cls_lift0._get_cls_lift0_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 90/*closeDoors*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 90/*closeDoors*/);
}
}
}